...
func Post_v2_customers_customerid_domains_registerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v2/customers/%s/domains/register", cfg.BaseURL, customerId)
...
func CreatePost_v2_customers_customerid_domains_registerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v2_customers_customerId_domains_register",
		mcp.WithDescription("Purchase and register the specified Domain"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v2_customers_customerid_domains_registerHandler(cfg),
	}
}
