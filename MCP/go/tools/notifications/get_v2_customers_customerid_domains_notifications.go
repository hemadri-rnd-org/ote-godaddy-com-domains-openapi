...
func Get_v2_customers_customerid_domains_notificationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v2/customers/%s/domains/notifications", cfg.BaseURL, customerId)
		...
		var result models.DomainNotification
...
func CreateGet_v2_customers_customerid_domains_notificationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v2_customers_customerId_domains_notifications",
		mcp.WithDescription("Retrieve the next domain notification"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v2_customers_customerid_domains_notificationsHandler(cfg),
	}
}
